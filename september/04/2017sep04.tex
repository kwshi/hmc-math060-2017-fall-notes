...
\fancypagestyle{notes}{
    \fancyhf{}
    \rhead{Monday, 4 September 2017 \\ \thepage\ / \pageref{LastPage}}
    \lhead{Math 60: Multivariable Calculus \\ Differentiable Functions, Chain Rule, Directional Derivatives, Relations to Gradient}
